...
func (Namespace) EnumDescriptor() ([]byte, []int) { return fileDescriptor12, []int{0} }
...
func (OverlayedType) EnumDescriptor() ([]byte, []int) { return fileDescriptor12, []int{1} }
...
func (*Filter) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{0} }
...
func (*OverlayedEntity) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{1} }
...
func (*BettingOverlay) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{2} }
...
func (*Overlay) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{3} }
...
func (*BettingOverlays) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{4} }
...
func (*EntityBettingOverlays) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{5} }
...
func (*MarketOverlays) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{6} }
...
func (*RemoveBettingOverlayRequest) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{7} }
...
func (*DetailedLookup) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{8} }
...
func (*GetBettingOverlayRequest) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{9} }
...
func (*BatchGetBettingOverlayRequest) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{10} }
...
func init() { proto.RegisterFile("internalrpc/risk_manager.proto", fileDescriptor12) }
