...
func (*Selection) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{0} }
...
func (*Line) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{1} }
...
func init() { proto.RegisterFile("internalrpc/pinnacle_broker.proto", fileDescriptor9) }
