...
func (PlayerTags) EnumDescriptor() ([]byte, []int) { return fileDescriptor13, []int{0} }
...
func (*PlayerRequest) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{0} }
...
func (*PlayerReply) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{1} }
...
func (*RestrictedIDs) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{2} }
...
func init() { proto.RegisterFile("internalrpc/sportsbook_api.proto", fileDescriptor13) }
