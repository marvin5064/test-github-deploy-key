...
func (*Uint32List) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{0} }
...
func (*SingleId) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{1} }
...
func (*Double) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{2} }
...
func (*HealthCheckResponse) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{3} }
...
func init() { proto.RegisterFile("internalrpc/generic.proto", fileDescriptor4) }
