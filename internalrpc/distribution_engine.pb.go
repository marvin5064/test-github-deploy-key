...
func (*MultipleCompetition) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{0} }
...
func (*MultipleCompetitionList) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{1} }
...
func (*EvictionRequest) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{2} }
...
func (*CompetitionList) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{5} }
...
func (*CompetitionLists) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{6} }
...
func init() { proto.RegisterFile("internalrpc/distribution_engine.proto", fileDescriptor2) }
