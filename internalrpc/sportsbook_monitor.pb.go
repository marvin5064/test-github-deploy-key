...
func (*SetLockingStatusRequest) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{0} }
...
func (*OverrideSelectionStatusRequest) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{1} }
...
func (*OverrideSelectionStatusReply) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{2} }
...
func (*FullLockingStatusReply) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{3} }
...
func (*LockingStatus) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{4} }
...
func (*KeepAliveRequest) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{5} }
...
func init() { proto.RegisterFile("internalrpc/sportsbook_monitor.proto", fileDescriptor14) }
