...
func (*PinnacleLiveStatusReply) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{0} }
...
func (*SpecialMarketRequest) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{1} }
...
func (*SpecialMarketsForEventRequest) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{2} }
...
func (*BlockedSpecialMarketsList) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{3} }
...
func init() { proto.RegisterFile("internalrpc/pinnacle_worker.proto", fileDescriptor9) }
